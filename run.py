...
NlLen_map = {"Time":400, "Math":4500, "Lang":280, "Chart": 1000, "Mockito":650, "unknown":2200}
...
def train(t = 5, p='Math'):
    ...
    for epoch in range(20):
        ...
        for dBatch in tqdm(train_set.Get_Train(args.batch_size)):
            ...
            loss, _, _ = model(dBatch[0], dBatch[1], dBatch[2], dBatch[3], dBatch[4], dBatch[5], dBatch[6], dBatch[7], devBatch[8])
